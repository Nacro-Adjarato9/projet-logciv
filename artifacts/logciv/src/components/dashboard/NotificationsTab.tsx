          ...
          {myNotifs.map((n) => {
            ...
            return (
              <button key={n.id} type="button"
                className={`w-full text-left flex items-start gap-4 p-4 rounded-xl border transition-all hover:shadow-sm ${n.read ? "bg-card border-border" : "bg-primary/3 border-primary/20"}`}
